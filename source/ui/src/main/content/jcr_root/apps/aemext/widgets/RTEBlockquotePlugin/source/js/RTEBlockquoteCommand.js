...
AEMEXT.Widgets.rte.commands.RTEBlockquoteCommand = CQ.Ext.extend(CQ.form.rte.commands.Command, {
...
// register command
CQ.form.rte.commands.CommandRegistry.register("rteblockquotecommand", AEMEXT.Widgets.rte.commands.RTEBlockquoteCommand);