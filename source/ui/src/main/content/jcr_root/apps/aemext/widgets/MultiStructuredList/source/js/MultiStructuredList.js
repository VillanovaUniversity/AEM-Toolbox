...
CQ.Ext.ns('AEMEXT.Widgets');

AEMEXT.Widgets.MultiStructuredList = CQ.Ext.extend(CQ.form.Slideshow, {
	/**
	...
	constructor: function(config) {
		...
		var defaults = {
			"headPanel": new AEMEXT.Widgets.MultiStructuredList.SlidesPanel({
			...
			"footPanel": new AEMEXT.Widgets.MultiStructuredList.SlideSettingsPanel({"items": settings}),
		...
		AEMEXT.Widgets.MultiStructuredList.superclass.constructor.call(this, config);
	...
	initComponent: function() {
		...
		AEMEXT.Widgets.MultiStructuredList.superclass.initComponent.call(this);
	},
	...
	toolClicked: function(tool) {
		...
		AEMEXT.Widgets.MultiStructuredList.superclass.toolClicked.call(this, tool);
	},
	...
	commandToolClicked: function(tool) {
		...
		AEMEXT.Widgets.MultiStructuredList.superclass.commandToolClicked.call(this, tool);
	},
	...
	handleDrop: function(dragData) {
		...
		AEMEXT.Widgets.MultiStructuredList.superclass.handleDrop.call(this, dragData);
	},
	...
	createSlide: function(data, slideIndex, basePath) {
		...
		if (data) {
			...
			// add existing slide
			slide = new AEMEXT.Widgets.MultiStructuredList.Slide(slideConfig);
...
CQ.Ext.reg("multiStructuredList", AEMEXT.Widgets.MultiStructuredList);